...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 31875473-fbda-4825-b17a-456a50d74157
```

> `31875473-fbda-4825-b17a-456a50d74157` is the password of the certificate, you can change it to any password you want.
